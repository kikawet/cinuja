    ...
    <body class="">
        ...
        <div class="my-xl-5 mx-lg-5">
            <div class="bg-white m-auto mh-700" style="height: 700px">
                ...
                <form:form method="POST" modelAttribute="usuarioDTO">
                    <div class="form-row">
                    ...
                    <div class="form-row ">
                        <div class="col-md-4 mb-3 ml-auto">
                            ...
                            <form:input cssClass="form-control " id="validationServer04" placeholder="Contraseña" path="contrasena" />
                            <div class=""></div>
                        </div>

                        <div class="col-md-4 mb-3 mr-auto">
                            <label for="validationServer05">Repetir Contraseña</label>
                            <input type="text" class="form-control " id="validationServer05" name="contrasena2" placeholder="Contraseña" value="${contrasena2}" >
                            <div class=""></div>
                        </div>
